...
if (api.isInputGenerationExecution()) {
    // Input Generation Execution mode: create input parameter
    api.inputBuilderFactory()
            .createIntegerUserEntry(INPUT_NAME_QUANTITY)
            .setLabel(INPUT_LABEL_QUANTITY)
            .setRequired(true)
            .getInput()
} else {
    // Non-Input Generation Execution mode: read, validate and return input values
